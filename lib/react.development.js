    ...
    Object.defineProperties(lazyType, {
      defaultProps: {
        ...
        set: function (newDefaultProps) {
          warning$1(false, 'React.lazy(...): It is not supported to assign `defaultProps` to ' + 'a lazy component . Either specify them where the component ' + 'is defined, or create a wrapping component around it.');
      ...
      propTypes: {
        ...
        set: function (newPropTypes) {
          warning$1(false, 'React.lazy(...): It is not supported to assign `propTypes` to ' + 'a lazy component . Either specify them where the component ' + 'is defined, or create a wrapping component around it.');
...
typeof MessageChannel !== 'function') {
  // If this accidentally gets ed in a non-browser environment, e.g. JavaScriptCore,
